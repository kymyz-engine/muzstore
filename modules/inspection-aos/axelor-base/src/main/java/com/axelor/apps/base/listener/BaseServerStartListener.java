...
import com.axelor.apps.base.service.migration.SqlMigrationService;
...
public class BaseServerStartListener {
  ...
  @Inject private SqlMigrationService sqlMigrationService;
  ...
  public void startUpEventListener(@Observes StartupEvent startupEvent) {
    // Add all timezones
    sqlMigrationService.runMigrations();
